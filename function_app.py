...
@app.function_name(name="login_user")
@app.route(route="login_user", auth_level=func.AuthLevel.FUNCTION, methods=["POST"])
...
@app.function_name(name="logout_user")
@app.route(route="logout_user", auth_level=func.AuthLevel.FUNCTION, methods=["POST"])
...
@app.function_name(name="register-users-ms")
@app.route(route="register-users-ms", auth_level=func.AuthLevel.FUNCTION, methods=["POST"])
def register_users_ms(req: func.HttpRequest) -> func.HttpResponse:
